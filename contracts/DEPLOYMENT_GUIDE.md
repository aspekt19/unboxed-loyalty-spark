...
### ⚠️ Минимальная сумма для инвестирования
- **MIN_INVEST_AMOUNT = 0.001 ETH** (~$3-4)
- Round-up накапливается в `pendingRoundUp` пока не достигнет минимума
- Это защищает от потери средств на gas при маленьких суммах
- Aave Strategy делает: ETH → WETH → USDC → Aave Supply
