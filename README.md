...
Merchant Workflow
Click "Access Merchant Portal"
Connect your merchant wallet (must have mint permissions)
Enter customer's wallet address (0x...)
Specify amount of loyalty points to issue
Click "Mint Loyalty Points"
Confirm transaction in wallet
Wait for blockchain confirmation
Note: Only wallets with merchant privileges can successfully mint points.

Customer Workflow
Click "Access Customer Portal"
Connect your wallet
View your current loyalty point balance
Navigate to redemption section
Enter amount of points to redeem
Click "Redeem Points"
Confirm the burn transaction
Receive confirmation of successful redemption
...
Acknowledgments
Built on Base - Ethereum L2 by Coinbase
UI components by shadcn/ui
Powered by Ethers.js
Designed for Farcaster Frame integration
