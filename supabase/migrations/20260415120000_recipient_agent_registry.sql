...
CREATE TABLE public.recipient_agent_registry (
...
CREATE UNIQUE INDEX recipient_agent_registry_api_key_hash_key
  ON public.recipient_agent_registry (api_key_hash);

CREATE INDEX recipient_agent_registry_wallet_idx
...
CREATE TABLE public.recipient_agent_activity_log (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX recipient_agent_activity_log_agent_time_idx
