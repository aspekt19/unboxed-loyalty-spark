...
status = [
    ...
    ("23 REST + 28 MCP", "инструментов для агентов (+11 recipient MCP)"),
...
rows = [
    ...
    ("Q3–Q4 2026", "10–25 платящих бизнесов", "Тарифы Starter/Growth, кейсы"),
    ("Q1–Q2 2027", "100+ бизнесов", "Канал агентов: OpenServ, MCP-каталоги, x402"),
    ("H2 2027", "500+ бизнесов", "Мультирегиональный SaaS + выручка с агентов"),
]
# header
hy = Inches(2.5)
