...
API: 28 merchant REST (authenticated) + 1 public + 14 recipient REST + 39 merchant MCP + 20 recipient MCP (direct); 34 merchant + 16 recipient MCP tools via paid x402 corridor
