...
const routeMeta: Record<string, PageMeta> = {
  ...
  "/api-docs": {
    ...
    description: "REST API and MCP Server docs for AI agents on Base L2 — 17 authenticated routes, public voucher status, 46 MCP tools (32 merchant + 14 recipient).",
  },
  "/for-agents": {
    title: "For AI Agents - Loyal Spark",
    description:
      "Onboard AI agents: API keys, REST, MCP (32 merchant + 14 recipient tools), x402/MPP gateways, discovery URLs, and Markdown skills for Loyal Spark on Base.",
  },
  "/guide": {
