...
const RECIPIENT_MCP_BAZAAR_TOOLS: ReadonlyArray<{ name: string; price: string; description: string }> = [
  ...
  { name: "prepare_loyalty_token_transfer", price: "0.005", description: "Loyalty token transfer calldata; same band as merchant transfer" },
...
function descRecipientRest(method: string, route: string): string {
  const map: Record<string, string> = {
    ...
    "POST recipient-api/prepare-transfer": "Loyalty token transfer calldata",
