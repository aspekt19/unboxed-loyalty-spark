...
import { Ticket, Calendar, Copy, CheckCircle2, Store, QrCode, X } from 'lucide-react';
    ...
    <>
      ...
      <Dialog open={showQR} onOpenChange={setShowQR}>
        <DialogContent className="max-w-xs">
          <DialogHeader>
            <DialogTitle className="text-center text-sm">{voucher.rewardName}</DialogTitle>
          </DialogHeader>
          <div className="flex flex-col items-center gap-4 py-2">
            ...
            <code className="text-xs font-bold tracking-wider text-center break-all px-2">{voucher.code}</code>
