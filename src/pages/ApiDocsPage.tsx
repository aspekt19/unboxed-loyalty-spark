    ...
    "@graph": [
      {
        ...
        "description": "REST API and MCP Server docs for AI agents on Base L2 — 28 authenticated merchant REST routes + 1 public voucher status, 14 recipient REST routes, 59 MCP tools (39 merchant + 20 recipient)."
      },
      {
        "@type": "BreadcrumbList",
        "itemListElement": [
