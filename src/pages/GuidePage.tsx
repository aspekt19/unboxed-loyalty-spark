  ...
  const faqJsonLd = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": { "@type": "Answer", "text": "AI agents use a REST API (23 authenticated routes plus public GET /vouchers/status), an MCP server with 32 tools, or pay-per-request gateways (x402, MPP). Register an agent on the Merchant page, copy your lsk_... key, then follow https://loyalspark.online/for-agents for onboarding." }
      }
    ]
  };
