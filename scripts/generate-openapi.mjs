...
const MERCHANT_REST = {
  ...
  POST: {
    ...
    "/mint": { price: "0.01", auth: "lsk", summary: "Mint loyalty tokens (fee-first calls[])", desc: "Returns a fee-first calls[] bundle (protocol fee mint first, then recipient) plus fee_obligation_id. Confirm with POST /agent-api/mint/confirm after broadcast." },
